...
%%  Metadane dokumentu 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\title{Aplikacja mobilna ułatwiająca podróżowanie samochodami elektrycznymi}
\titleEN{Mobile application that facilitates traveling by electric cars}
\author{Nikita Stepanenko}
\uczelnia{POLITECHNIKA WROCŁAWSKA}
\wydzial{WYDZIAŁ ELEKTRONIKI}
\kierunek{INFORMATYKA}
\specjalnosc{INŻYNIERIA SYSTEMÓW INFORMATYCZNYCH}
\promotor{dr inż.\ Tomasz Kubik, K30W04D03}
\date{WROCŁAW, 2020}
