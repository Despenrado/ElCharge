...
\begin{itemize}
    ...
    \item Google Cloud Platform -- zdalny serwis, sworzony prze Google, który umozliwia dostęp do pracy z mapą.
\end{itemize}

\begin{figure}[ht]
    \centering
        \includegraphics[width=0.7\linewidth]{rys02/system_architecture_diagram4.png}
    \caption{Zarys architektury systemu} % TO DO: jeśli korzystał Pan z diagrams.net do narysowania diagramu, to nie trzeba tego cytować. Cytowanie może pojawić się przy opisie wykorzystanych narzędzi. \cite{diagrams_net} [TO VERIFY]
...
\begin{table}[htb] \small
    ...
    % Ułatwienie wyszukiwania najwygodniejszej stacji ładowniczej \\
...
\begin{table}[htb] \small
    ...
    \hline
    13 & Dostęp & Dane o stacjach ładowniczych oraz komentarzy przechowywane zdalnie, żeby różni użytkownicy miały do nich dostęp \\
    \hline
