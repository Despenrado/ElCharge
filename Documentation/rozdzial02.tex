...
Podczas tworzenia stacji ładowania (rys. \ref{fig:create_makiet}a) dla wygody użytkowania można wybrać miejsce na mapie poprzez odpowiedni przycisk.
...
Na stronie informacji o stacji (rys.\ref{fig:create_makiet}b) oprócz nazwy stacji, opisu oraz oceny, wyliczonej na podstawie komentarzy oceny, znajdują się komentarzy uzytkowników w porządku: najpierw najnowsze.

Dla rejestracji i logowania wykorzystują się dwa różne ekrany (rys.\ref{fig:login_makiet}a oraz \ref{fig:login_makiet}b)
\begin{figure}[ht]
	\centering
  \begin{tabular}{@{}rl@{\hspace{10mm}}rl@{}}
